...
/*=============== SWIPER PRODUCTS ===============*/
let swiperprodocts = new Swiper(".products__container", {
    spaceBetween: 32,
    grabCursor: true,
    centeredSlides: true,
    slidesPreview: 'auto',
...
sr.reveal('.collection__explore:nth-childe(1)',{origin: 'right'})
sr.reveal('.collection__explore:nth-childe(2)',{origin: 'left'})
